...
@Component({
  ...
  imports: [RowComponent, ColComponent, CardComponent, CardHeaderComponent, CardBodyComponent, DocsExampleComponent, DateRangePickerComponent_1, TemplateIdDirective, ButtonDirective, DropdownCloseDirective, DatePipe, DocsComponentsComponent]
})
