...
# CoreUI Pro Admin Dashboard Template for Angular 20
...
- Clone the repo: `git clone https://github.com/coreui/coreui-pro-angular-admin-template.git`
...
###### Node.js
[**Angular 20**](https://angular.dev/overview) requires `Node.js` LTS version `^20.19.0 || ^22.12.0 || ^24.0.0`.
